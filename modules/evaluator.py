...
class ModelEvaluator:
    ...
    def evaluate_embeddings(
        ...
        """
        console.status(f"[bold blue]\\[embeddings][/bold blue] Evaluating embeddings using PCA → UMAP...")

        # First apply PCA to reduce noise and dimensionality
        console.status("[bold blue]\\[embeddings][/bold blue] Applying PCA dimensionality reduction...")
        ...
        # Then apply UMAP to the PCA-reduced embeddings
        ...
        console.status("[bold blue]\\[embeddings][/bold blue] Generating plots...")
    ...
    def _evaluate_confusion_matrix(self, y_true: List[int], y_pred: List[int], class_names: List[str], save_plots: bool) -> Dict[str, Any]:
        ...
        console.status("[bold blue]\\[evaluation][/bold blue] Evaluating confusion matrix...")
    ...
    def _per_class_evaluation(self, y_true: List[int], y_pred: List[int], class_names: List[str]) -> Dict[str, Any]:
        ...
        console.status("[bold blue]\\[evaluation][/bold blue] Evaluating per-class performance...")
        evaluation = {}
    ...
    def _confidence_evaluation(self, y_true: List[int], y_pred: List[int], y_logits: List[List[float]], save_plots: bool) -> Dict[str, Any]:
        ...
        console.status("[bold blue]\\[evaluation][/bold blue] Evaluating prediction confidence...")
    ...
    def _error_evaluation(self, y_true: List[int], y_pred: List[int], symptoms: List[str], class_names: List[str]) -> Dict[str, Any]:
        ...
        console.status("[bold blue]\\[evaluation][/bold blue] Evaluating error...")
        errors = []
    ...
    def _compute_embedding_stats(self, embeddings: np.ndarray, labels: List[int], class_names: List[str]) -> Dict[str, Any]:
        ...
        console.status("[bold blue]\\[embeddings][/bold blue] Computing embedding statistics...")
        stats = {
    ...
    def _save_metrics(self, results: Dict[str, Any]):
        ...
        output_path = os.path.join(self.output_dir, f"eval_metrics{self.run_id}.json")
...
def compute_metrics(
    ...
    console.log(f"[bold green]\\[evaluation][/bold green] Running model evaluation...")
    ...
    if test_embeddings is not None:
        console.status(f"[bold blue]\\[embeddings][/bold blue] Evaluating embeddings...")
